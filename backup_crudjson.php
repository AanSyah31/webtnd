...
if(isset($_GET['submit']))
{
    ...
    $json_arr['db_youtube'][] = array('id'=>$newId, 'video_id'=>$newVideoId, 'judul'=>$newJudul, 'tag'=>$newTag, 'kategori'=>$newKategori);
...
echo count($json_arr['db_youtube']);
