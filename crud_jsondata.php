                        ...
                        <tbody>
                            ...
                            <?php for ($i = 0; $i < count($json_arr['db_youtube']); $i++) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editjson.php?id=<?=$json_arr['db_youtube'][$i]['id'];?>"><abbr title='Edit Data'><i class='nav-icon fas fa-edit'></i></a>
                                        <a href="crud_jsondata.php?hapus=1&id=<?=$json_arr['db_youtube'][$i]['id'];?>"><abbr title='Hapus Data'><i class='nav-icon fas fa-trash-alt'></i></a>
                                    </td>
                                    <?php $no += 1; ?>
                                </tr>
                            <?php endfor; ?>
